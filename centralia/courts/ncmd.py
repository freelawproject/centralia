"""United States District Court, Middle District of North Carolina ('ncmd').
...
NCMD = register(CourtProfile(
    "ncmd", "United States District Court, Middle District of North Carolina",
...
@decider("headmatter.read", court="ncmd")
def read_headmatter_ncmd(model, geom, **kw):
    """Read ncmd's ECF pleading order, or NOTHING."""
