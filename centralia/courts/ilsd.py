"""United States District Court, Southern District of Illinois ('ilsd').
...
ILSD = register(CourtProfile(
    "ilsd", "United States District Court, Southern District of Illinois",
...
@decider("headmatter.read", court="ilsd")
def read_headmatter_ilsd(model, geom, **kw):
    """Read ilsd's ECF pleading order, or NOTHING."""
