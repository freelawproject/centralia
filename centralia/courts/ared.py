"""United States District Court, Eastern District of Arkansas ('ared').
...
ARED = register(CourtProfile(
    "ared", "United States District Court, Eastern District of Arkansas",
...
@decider("headmatter.read", court="ared")
def read_headmatter_ared(model, geom, **kw):
    """Read ared's ECF pleading order, or NOTHING."""
