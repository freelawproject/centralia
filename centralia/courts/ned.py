"""United States District Court, District of Nebraska ('ned').
...
NED = register(CourtProfile(
    "ned", "United States District Court, District of Nebraska",
...
@decider("headmatter.read", court="ned")
def read_headmatter_ned(model, geom, **kw):
    """Read ned's ECF pleading order, or NOTHING."""
