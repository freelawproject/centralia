"""United States District Court, Northern District of New York ('nynd').
...
MEASURED: the shared reader reads 20% of a five-record sample with
...
NYND = register(CourtProfile(
    "nynd", "United States District Court, Northern District of New York",
...
@decider("headmatter.read", court="nynd")
def read_headmatter_nynd(model, geom, **kw):
    """Read nynd's ECF pleading order, or NOTHING."""
