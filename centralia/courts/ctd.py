"""United States District Court, District of Connecticut ('ctd').
...
CTD = register(CourtProfile(
    "ctd", "United States District Court, District of Connecticut",
...
@decider("headmatter.read", court="ctd")
def read_headmatter_ctd(model, geom, **kw):
    """Read ctd's ECF pleading order, or NOTHING."""
