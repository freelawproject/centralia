"""United States District Court, Western District of Wisconsin ('wiwd').
...
WIWD = register(CourtProfile(
    "wiwd", "United States District Court, Western District of Wisconsin",
...
@decider("headmatter.read", court="wiwd")
def read_headmatter_wiwd(model, geom, **kw):
    """Read wiwd's ECF pleading order, or NOTHING."""
