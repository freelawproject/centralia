"""United States District Court, Western District of Michigan ('miwd').
...
MIWD = register(CourtProfile(
    "miwd", "United States District Court, Western District of Michigan",
...
@decider("headmatter.read", court="miwd")
def read_headmatter_miwd(model, geom, **kw):
    """Read miwd's ECF pleading order, or NOTHING."""
