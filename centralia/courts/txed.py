"""United States District Court, Eastern District of Texas ('txed').
...
TXED = register(CourtProfile(
    "txed", "United States District Court, Eastern District of Texas",
...
@decider("headmatter.read", court="txed")
def read_headmatter_txed(model, geom, **kw):
    """Read txed's ECF pleading order, or NOTHING."""
