"""United States District Court, Eastern District of Washington ('waed').
...
WAED = register(CourtProfile(
    "waed", "United States District Court, Eastern District of Washington",
...
@decider("headmatter.read", court="waed")
def read_headmatter_waed(model, geom, **kw):
    """Read waed's ECF pleading order, or NOTHING."""
