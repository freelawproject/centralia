"""United States District Court, Eastern District of New York ('nyed').
...
NYED = register(CourtProfile(
    "nyed", "United States District Court, Eastern District of New York",
...
@decider("headmatter.read", court="nyed")
def read_headmatter_nyed(model, geom, **kw):
    """Read nyed's ECF pleading order, or NOTHING."""
