"""United States District Court, Western District of North Carolina ('ncwd').
...
NCWD = register(CourtProfile(
    "ncwd", "United States District Court, Western District of North Carolina",
...
@decider("headmatter.read", court="ncwd")
def read_headmatter_ncwd(model, geom, **kw):
    """Read ncwd's ECF pleading order, or NOTHING."""
