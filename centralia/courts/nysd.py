"""United States District Court, Southern District of New York ('nysd').
...
MEASURED: the shared reader reads 40% of a five-record sample with
...
NYSD = register(CourtProfile(
    "nysd", "United States District Court, Southern District of New York",
...
@decider("headmatter.read", court="nysd")
def read_headmatter_nysd(model, geom, **kw):
    """Read nysd's ECF pleading order, or NOTHING."""
