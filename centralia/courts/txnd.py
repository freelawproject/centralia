"""United States District Court, Northern District of Texas ('txnd').
...
TXND = register(CourtProfile(
    "txnd", "United States District Court, Northern District of Texas",
...
@decider("headmatter.read", court="txnd")
def read_headmatter_txnd(model, geom, **kw):
    """Read txnd's ECF pleading order, or NOTHING."""
