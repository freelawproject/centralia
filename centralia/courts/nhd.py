"""United States District Court, District of New Hampshire ('nhd').
...
NHD = register(CourtProfile(
    "nhd", "United States District Court, District of New Hampshire",
...
@decider("headmatter.read", court="nhd")
def read_headmatter_nhd(model, geom, **kw):
    """Read nhd's ECF pleading order, or NOTHING."""
