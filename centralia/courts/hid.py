"""United States District Court, District of Hawaii ('hid').
...
HID = register(CourtProfile(
    "hid", "United States District Court, District of Hawaii",
...
@decider("headmatter.read", court="hid")
def read_headmatter_hid(model, geom, **kw):
    """Read hid's ECF pleading order, or NOTHING."""
