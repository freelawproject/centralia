"""United States District Court, Eastern District of North Carolina ('nced').
...
NCED = register(CourtProfile(
    "nced", "United States District Court, Eastern District of North Carolina",
...
@decider("headmatter.read", court="nced")
def read_headmatter_nced(model, geom, **kw):
    """Read nced's ECF pleading order, or NOTHING."""
