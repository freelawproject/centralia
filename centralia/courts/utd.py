"""United States District Court, District of Utah ('utd').
...
UTD = register(CourtProfile(
    "utd", "United States District Court, District of Utah",
...
@decider("headmatter.read", court="utd")
def read_headmatter_utd(model, geom, **kw):
    """Read utd's ECF pleading order, or NOTHING."""
