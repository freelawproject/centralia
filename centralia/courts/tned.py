"""United States District Court, Eastern District of Tennessee ('tned').
...
TNED = register(CourtProfile(
    "tned", "United States District Court, Eastern District of Tennessee",
...
@decider("headmatter.read", court="tned")
def read_headmatter_tned(model, geom, **kw):
    """Read tned's ECF pleading order, or NOTHING."""
