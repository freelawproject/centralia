"""United States District Court, Southern District of Texas ('txsd').
...
TXSD = register(CourtProfile(
    "txsd", "United States District Court, Southern District of Texas",
...
@decider("headmatter.read", court="txsd")
def read_headmatter_txsd(model, geom, **kw):
    """Read txsd's ECF pleading order, or NOTHING."""
