"""United States District Court, Northern District of Georgia ('gand').
...
GAND = register(CourtProfile(
    "gand", "United States District Court, Northern District of Georgia",
...
@decider("headmatter.read", court="gand")
def read_headmatter_gand(model, geom, **kw):
    """Read gand's ECF pleading order, or NOTHING."""
