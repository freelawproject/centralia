"""United States District Court, Southern District of Georgia ('gasd').
...
GASD = register(CourtProfile(
    "gasd", "United States District Court, Southern District of Georgia",
...
@decider("headmatter.read", court="gasd")
def read_headmatter_gasd(model, geom, **kw):
    """Read gasd's ECF pleading order, or NOTHING."""
