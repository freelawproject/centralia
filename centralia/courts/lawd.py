"""United States District Court, Western District of Louisiana ('lawd').
...
LAWD = register(CourtProfile(
    "lawd", "United States District Court, Western District of Louisiana",
...
@decider("headmatter.read", court="lawd")
def read_headmatter_lawd(model, geom, **kw):
    """Read lawd's ECF pleading order, or NOTHING."""
