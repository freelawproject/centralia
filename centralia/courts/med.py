"""United States District Court, District of Maine ('med').
...
MED = register(CourtProfile(
    "med", "United States District Court, District of Maine",
...
@decider("headmatter.read", court="med")
def read_headmatter_med(model, geom, **kw):
    """Read med's ECF pleading order, or NOTHING."""
