"""United States District Court, District of Wyoming ('wyd').
...
WYD = register(CourtProfile(
    "wyd", "United States District Court, District of Wyoming",
...
@decider("headmatter.read", court="wyd")
def read_headmatter_wyd(model, geom, **kw):
    """Read wyd's ECF pleading order, or NOTHING."""
