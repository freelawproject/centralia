"""United States District Court, Southern District of Indiana ('insd').
...
INSD = register(CourtProfile(
    "insd", "United States District Court, Southern District of Indiana",
...
@decider("headmatter.read", court="insd")
def read_headmatter_insd(model, geom, **kw):
    """Read insd's ECF pleading order, or NOTHING."""
