"""United States District Court, Central District of Illinois ('ilcd').
...
ILCD = register(CourtProfile(
    "ilcd", "United States District Court, Central District of Illinois",
...
@decider("headmatter.read", court="ilcd")
def read_headmatter_ilcd(model, geom, **kw):
    """Read ilcd's ECF pleading order, or NOTHING."""
