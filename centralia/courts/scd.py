"""United States District Court, District of South Carolina ('scd').
...
SCD = register(CourtProfile(
    "scd", "United States District Court, District of South Carolina",
...
@decider("headmatter.read", court="scd")
def read_headmatter_scd(model, geom, **kw):
    """Read scd's ECF pleading order, or NOTHING."""
