"""United States District Court, Eastern District of Louisiana ('laed').
...
LAED = register(CourtProfile(
    "laed", "United States District Court, Eastern District of Louisiana",
...
@decider("headmatter.read", court="laed")
def read_headmatter_laed(model, geom, **kw):
    """Read laed's ECF pleading order, or NOTHING."""
