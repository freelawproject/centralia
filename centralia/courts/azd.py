"""United States District Court, District of Arizona ('azd').
...
AZD = register(CourtProfile(
    "azd", "United States District Court, District of Arizona",
...
@decider("headmatter.read", court="azd")
def read_headmatter_azd(model, geom, **kw):
    """Read azd's ECF pleading order, or NOTHING."""
