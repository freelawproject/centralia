"""United States District Court, Western District of Texas ('txwd').
...
TXWD = register(CourtProfile(
    "txwd", "United States District Court, Western District of Texas",
...
@decider("headmatter.read", court="txwd")
def read_headmatter_txwd(model, geom, **kw):
    """Read txwd's ECF pleading order, or NOTHING."""
