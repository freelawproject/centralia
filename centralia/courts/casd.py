"""United States District Court, Southern District of California ('casd').
...
CASD = register(CourtProfile(
    "casd", "United States District Court, Southern District of California",
...
@decider("headmatter.read", court="casd")
def read_headmatter_casd(model, geom, **kw):
    """Read casd's ECF pleading order, or NOTHING."""
