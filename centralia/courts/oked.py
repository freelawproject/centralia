"""United States District Court, Eastern District of Oklahoma ('oked').
...
OKED = register(CourtProfile(
    "oked", "United States District Court, Eastern District of Oklahoma",
...
@decider("headmatter.read", court="oked")
def read_headmatter_oked(model, geom, **kw):
    """Read oked's ECF pleading order, or NOTHING."""
