"""United States District Court, District of Minnesota ('mnd').
...
MND = register(CourtProfile(
    "mnd", "United States District Court, District of Minnesota",
...
@decider("headmatter.read", court="mnd")
def read_headmatter_mnd(model, geom, **kw):
    """Read mnd's ECF pleading order, or NOTHING."""
