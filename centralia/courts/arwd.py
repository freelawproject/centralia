"""United States District Court, Western District of Arkansas ('arwd').
...
ARWD = register(CourtProfile(
    "arwd", "United States District Court, Western District of Arkansas",
...
@decider("headmatter.read", court="arwd")
def read_headmatter_arwd(model, geom, **kw):
    """Read arwd's ECF pleading order, or NOTHING."""
