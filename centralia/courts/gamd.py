"""United States District Court, Middle District of Georgia ('gamd').
...
GAMD = register(CourtProfile(
    "gamd", "United States District Court, Middle District of Georgia",
...
@decider("headmatter.read", court="gamd")
def read_headmatter_gamd(model, geom, **kw):
    """Read gamd's ECF pleading order, or NOTHING."""
