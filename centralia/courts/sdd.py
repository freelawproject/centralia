"""United States District Court, District of South Dakota ('sdd').
...
SDD = register(CourtProfile(
    "sdd", "United States District Court, District of South Dakota",
...
@decider("headmatter.read", court="sdd")
def read_headmatter_sdd(model, geom, **kw):
    """Read sdd's ECF pleading order, or NOTHING."""
