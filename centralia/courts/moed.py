"""United States District Court, Eastern District of Missouri ('moed').
...
MOED = register(CourtProfile(
    "moed", "United States District Court, Eastern District of Missouri",
...
@decider("headmatter.read", court="moed")
def read_headmatter_moed(model, geom, **kw):
    """Read moed's ECF pleading order, or NOTHING."""
