"""United States District Court, Southern District of Mississippi ('mssd').
...
MSSD = register(CourtProfile(
    "mssd", "United States District Court, Southern District of Mississippi",
...
@decider("headmatter.read", court="mssd")
def read_headmatter_mssd(model, geom, **kw):
    """Read mssd's ECF pleading order, or NOTHING."""
