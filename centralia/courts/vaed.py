"""United States District Court, Eastern District of Virginia ('vaed').
...
VAED = register(CourtProfile(
    "vaed", "United States District Court, Eastern District of Virginia",
...
@decider("headmatter.read", court="vaed")
def read_headmatter_vaed(model, geom, **kw):
    """Read vaed's ECF pleading order, or NOTHING."""
