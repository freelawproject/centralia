"""United States District Court, Eastern District of Wisconsin ('wied').
...
WIED = register(CourtProfile(
    "wied", "United States District Court, Eastern District of Wisconsin",
...
@decider("headmatter.read", court="wied")
def read_headmatter_wied(model, geom, **kw):
    """Read wied's ECF pleading order, or NOTHING."""
