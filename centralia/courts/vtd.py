"""United States District Court, District of Vermont ('vtd').
...
VTD = register(CourtProfile(
    "vtd", "United States District Court, District of Vermont",
...
@decider("headmatter.read", court="vtd")
def read_headmatter_vtd(model, geom, **kw):
    """Read vtd's ECF pleading order, or NOTHING."""
