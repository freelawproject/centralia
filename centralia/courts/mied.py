"""United States District Court, Eastern District of Michigan ('mied').
...
MIED = register(CourtProfile(
    "mied", "United States District Court, Eastern District of Michigan",
...
@decider("headmatter.read", court="mied")
def read_headmatter_mied(model, geom, **kw):
    """Read mied's ECF pleading order, or NOTHING."""
