"""United States District Court, Middle District of Florida ('flmd').
...
FLMD = register(CourtProfile(
    "flmd", "United States District Court, Middle District of Florida",
...
@decider("headmatter.read", court="flmd")
def read_headmatter_flmd(model, geom, **kw):
    """Read flmd's ECF pleading order, or NOTHING."""
