"""United States District Court, District of North Dakota ('ndd').
...
NDD = register(CourtProfile(
    "ndd", "United States District Court, District of North Dakota",
...
@decider("headmatter.read", court="ndd")
def read_headmatter_ndd(model, geom, **kw):
    """Read ndd's ECF pleading order, or NOTHING."""
