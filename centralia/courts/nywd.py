"""United States District Court, Western District of New York ('nywd').
...
NYWD = register(CourtProfile(
    "nywd", "United States District Court, Western District of New York",
...
@decider("headmatter.read", court="nywd")
def read_headmatter_nywd(model, geom, **kw):
    """Read nywd's ECF pleading order, or NOTHING."""
