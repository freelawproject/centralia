"""United States District Court, Western District of Pennsylvania ('pawd').
...
PAWD = register(CourtProfile(
    "pawd", "United States District Court, Western District of Pennsylvania",
...
@decider("headmatter.read", court="pawd")
def read_headmatter_pawd(model, geom, **kw):
    """Read pawd's ECF pleading order, or NOTHING."""
