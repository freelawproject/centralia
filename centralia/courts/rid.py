"""United States District Court, District of Rhode Island ('rid').
...
RID = register(CourtProfile(
    "rid", "United States District Court, District of Rhode Island",
...
@decider("headmatter.read", court="rid")
def read_headmatter_rid(model, geom, **kw):
    """Read rid's ECF pleading order, or NOTHING."""
