"""United States District Court, Western District of Washington ('wawd').
...
WAWD = register(CourtProfile(
    "wawd", "United States District Court, Western District of Washington",
...
@decider("headmatter.read", court="wawd")
def read_headmatter_wawd(model, geom, **kw):
    """Read wawd's ECF pleading order, or NOTHING."""
