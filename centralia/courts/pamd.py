"""United States District Court, Middle District of Pennsylvania ('pamd').
...
PAMD = register(CourtProfile(
    "pamd", "United States District Court, Middle District of Pennsylvania",
...
@decider("headmatter.read", court="pamd")
def read_headmatter_pamd(model, geom, **kw):
    """Read pamd's ECF pleading order, or NOTHING."""
