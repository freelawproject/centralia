"""United States District Court, District of New Jersey ('njd').
...
NJD = register(CourtProfile(
    "njd", "United States District Court, District of New Jersey",
...
@decider("headmatter.read", court="njd")
def read_headmatter_njd(model, geom, **kw):
    """Read njd's ECF pleading order, or NOTHING."""
