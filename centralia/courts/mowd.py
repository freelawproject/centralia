"""United States District Court, Western District of Missouri ('mowd').
...
MOWD = register(CourtProfile(
    "mowd", "United States District Court, Western District of Missouri",
...
@decider("headmatter.read", court="mowd")
def read_headmatter_mowd(model, geom, **kw):
    """Read mowd's ECF pleading order, or NOTHING."""
