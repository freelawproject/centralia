"""United States District Court, Middle District of Louisiana ('lamd').
...
LAMD = register(CourtProfile(
    "lamd", "United States District Court, Middle District of Louisiana",
...
@decider("headmatter.read", court="lamd")
def read_headmatter_lamd(model, geom, **kw):
    """Read lamd's ECF pleading order, or NOTHING."""
